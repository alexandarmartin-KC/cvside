-- CreateEnum
CREATE TYPE "AppliedJobStatus" AS ENUM ('SAVED', 'APPLIED', 'INTERVIEW', 'OFFER', 'REJECTED');
...
CREATE TABLE "AppliedJob" (
    ...
    "userId" TEXT NOT NULL,
    "jobId" TEXT NOT NULL,
    "status" "AppliedJobStatus" NOT NULL DEFAULT 'SAVED',
...
-- CreateIndex
CREATE INDEX "AppliedJob_userId_status_idx" ON "AppliedJob"("userId", "status");

-- CreateIndex
CREATE UNIQUE INDEX "AppliedJob_userId_jobId_key" ON "AppliedJob"("userId", "jobId");

-- CreateIndex
CREATE INDEX "SeenJob_userId_seenAt_idx" ON "SeenJob"("userId", "seenAt");

-- CreateIndex
CREATE UNIQUE INDEX "SeenJob_userId_jobId_key" ON "SeenJob"("userId", "jobId");
...
-- AddForeignKey
ALTER TABLE "SeenJob" ADD CONSTRAINT "SeenJob_jobId_fkey" FOREIGN KEY ("jobId") REFERENCES "Job"("id") ON DELETE CASCADE ON UPDATE CASCADE;
