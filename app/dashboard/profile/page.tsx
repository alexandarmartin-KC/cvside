...
export default async function ProfilePage() {
  ...
  if (!cvProfile) {
    return (
      <div className="space-y-6">
        <h1 className="text-3xl font-bold text-gray-900">Base Profile</h1>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8 text-center">
          ...
          <p className="text-gray-700 mb-6">
            Upload your CV to create your base profile and get personalized job matches
          </p>
          <Link
            href="/upload"
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Base Profile</h1>
        <p className="text-gray-600 mt-1">This is your base profile used for job matching</p>
      </div>
